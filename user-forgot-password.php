...
if ($_POST["vercode"] != $_SESSION["vercode"] OR $_SESSION["vercode"]=='')  {
        echo "<script>alert('Yanlış doğrulama kodu');</script>" ;
    } 
        else {
$email=$_POST['email'];
$mobile=$_POST['mobile'];
...
echo "<script>alert('E-posta kimliği veya telefon numarası geçersiz ');</script>"; 
}
}
}
?>
...
<head>
    ...
    <title>Kütüphane Yönetim Sistemi | Şifremi Unuttum </title>
...
<div class="col-md-12">
<h4 class="header-line">Şifremi Unuttum</h4>
</div>
</div>
...
<input type="text" class="form-control1"  name="vercode" maxlength="5" autocomplete="off" required  style="height:25px;" />&nbsp;<img src="captcha.php">
 ...
 <button type="submit" name="change" class="btn btn-info">Şifreyi Değiştir</button> | <a href="index.php">Giriş Yap</a>
</form>
 </div>
</div>
</div>
