...
$query->execute();
$_SESSION['updatemsg']="Kategori güncelleme başarılı";
...
<head>
    ...
    <title>Kütüphane Yönetim Sistemi | Kategori Düzenle</title>
...
<div class="radio">
<label>
<input type="radio" name="status" id="status" value="0" checked="checked">Deaktif
</label>
</div>
 <div class="radio">
<label>
