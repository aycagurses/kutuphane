...
$_SESSION['msg']="Kitap alma başarılı";
...
<head>
    ...
    <title>Kütüphane Yönetim Sistemi | Verilen Kitap Detayları</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Verilen Kitap Detayları</h4>
...
<button type="submit" name="return" id="submit" class="btn btn-info">Kitap Alındı </button>
