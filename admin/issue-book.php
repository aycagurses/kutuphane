...
if($lastInsertId)
{
$_SESSION['msg']="Kitap verme başarılı";
...
<head>
    ...
    <title>Kütüphane Yönetim Sistemi | Yeni Kitap Ver</title>
...
<label>Öğrenci Numarası<span style="color:red;">*</span></label>
...
<div class="form-group">
<label>ISBN Numarası veya Kitap Adı<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Kitabı Ver </button>
